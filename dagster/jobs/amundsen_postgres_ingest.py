...
POSTGRES_CONN_STRING = f"postgresql+psycopg2://{os.environ['POSTGRES_USER']}:" \
...
SUPPORTED_SCHEMAS = ['core', 'metadata', 'mart_match_performance', 'mart_player_performance', 'mart_team_standings']
